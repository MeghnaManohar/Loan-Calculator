...
#Contribution Chart
contribution_chart = dbc.Card(
    [
        dbc.Col(html.H5(children = "Contribution Chart:")),
        dbc.FormGroup(
            [
                    html.Div(id="contribution-chart"),
            ],
        )
    ],
    body=True
    ...
    [
        ...
        dbc.Row(
            [
                ...
                dbc.Col(
                    dcc.Graph(figure=fig, id='output-portfolio-chart')
                    )
            ],
        align="left",
        ),
        ...
        dbc.Row(
            [
                ...
                dbc.Col(contribution_chart, md=6) 
            ],
        align="left",
        ),
    ],
...
def chart_maker(n_clicks, input1, input2, input3, input4):
    if (input1 == None or input2 == None or input3 == None or input4 == None):
        return None, None  
    ...
    print(df)
    print(type(df))
    print(df['End Principal'])
    fig = px.bar(df, x="Payment Number", y="Begin Principal", title="Portfolio Bar Chart")
