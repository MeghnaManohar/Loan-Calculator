...
#Individual Chart
individual_chart = dbc.Card(
    [
        dbc.Col(html.H5(children = "Individual Loan(s) Chart:")),
        dbc.FormGroup(
            [
                    html.Div(id="output-individual-chart"),
            ],
        )
    ],
    body=True
...
port_chart = dbc.Card(
    [
        dbc.Col(html.H5(children = "Portfolio Chart:")),
        dbc.FormGroup(
            [
                    html.Div(id="output-portfolio-chart"),
            ],
        )
    ],
    body=True
...
app.layout = dbc.Container(
    [
        ...
        dbc.Row(
            [
                dbc.Col(individual_card, md=6),
                dbc.Col(individual_chart, md=6)
            ],
        align="left",
        ),
        #Portfolio Section
